...
##'
find.bins <- function(input.obj, exact=TRUE, ch=NULL)
{
    ...
    structure(list(bins=w,info=list(n.ind=input.obj$n.ind, n.mar=input.obj$n.mar, exact.search=exact)), class="onemap.bin")
}

##print method for object class 'onemap.bin'
print.onemap.bin<-function (x, ...) {
  ##printing brief summary of the data
  cat("This is an object of class 'onemap.bin'\n")
